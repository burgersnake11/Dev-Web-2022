...
<script>
  ...
  export default {
    ...
    initialize () {
        this.comptes = [];
        axios
        .get('https://testdev3heroku.herokuapp.com/api/gestion/users')
        .then((response) => {
    ...
    triage(){
        ...
        axios.get('https://testdev3heroku.herokuapp.com/api/gestion/users', {params: query_choisie})
        .then((response) => {
            this.content = response.data;
            this.comptes=[]
            for (let i in this.content){
      ...
      save () {
        ...
        axios
            .post("https://testdev3heroku.herokuapp.com/api/gestion/update", compte_json);
        this.close()
      },
      deleteItemConfirm(){
        let email_json = {
        ...
        axios
            .post("https://testdev3heroku.herokuapp.com/api/gestion/delete", email_json);
        this.initialize();
        this.closeDelete();
      },
      deleteItem(item) {
